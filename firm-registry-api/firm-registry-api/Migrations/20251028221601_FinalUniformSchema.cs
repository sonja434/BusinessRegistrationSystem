...
{
    /// <inheritdoc />
    public partial class FinalUniformSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    ActivitySectorId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EntrepreneurRequests_CompanyRequests_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                name: "JointStockCompanyRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false),
                    ShareCapital = table.Column<decimal>(type: "numeric", nullable: false),
                    BoardOfDirectors = table.Column<List<string>>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JointStockCompanyRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JointStockCompanyRequests_CompanyRequests_Id",
                        column: x => x.Id,
                        principalTable: "CompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitedCompanyRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitedCompanyRequests_CompanyRequests_Id",
                        column: x => x.Id,
                        principalTable: "CompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "LimitedPartnershipRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitedPartnershipRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitedPartnershipRequests_CompanyRequests_Id",
                        column: x => x.Id,
                        principalTable: "CompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartnershipRequests_CompanyRequests_Id",
                        column: x => x.Id,
                        principalTable: "CompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JMBG = table.Column<string>(type: "text", nullable: false),
                    AddressId = table.Column<int>(type: "integer", nullable: false),
                    EntrepreneurRequestId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Owners_EntrepreneurRequests_EntrepreneurRequestId",
                        column: x => x.EntrepreneurRequestId,
                        principalTable: "EntrepreneurRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JointStockCompanyRequestId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shareholders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Shareholders_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shareholders_JointStockCompanyRequests_JointStockCompanyReq~",
                        column: x => x.JointStockCompanyRequestId,
                        principalTable: "JointStockCompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "LimitedCompanyFounders",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    AddressId = table.Column<int>(type: "integer", nullable: false),
                    Share = table.Column<decimal>(type: "numeric", nullable: true),
                    LimitedCompanyRequestId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitedCompanyFounders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitedCompanyFounders_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LimitedCompanyFounders_LimitedCompanyRequests_LimitedCompan~",
                        column: x => x.LimitedCompanyRequestId,
                        principalTable: "LimitedCompanyRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<int>(type: "integer", nullable: false),
                    Share = table.Column<decimal>(type: "numeric", nullable: true),
                    LimitedPartnershipRequestId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralPartners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GeneralPartners_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GeneralPartners_LimitedPartnershipRequests_LimitedPartnersh~",
                        column: x => x.LimitedPartnershipRequestId,
                        principalTable: "LimitedPartnershipRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LimitedPartners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LimitedPartners_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LimitedPartners_LimitedPartnershipRequests_LimitedPartnersh~",
                        column: x => x.LimitedPartnershipRequestId,
                        principalTable: "LimitedPartnershipRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<int>(type: "integer", nullable: false),
                    Share = table.Column<decimal>(type: "numeric", nullable: true),
                    PartnershipRequestId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Partners_PartnershipRequests_PartnershipRequestId",
                        column: x => x.PartnershipRequestId,
                        principalTable: "PartnershipRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 20, 1, "1.43", "Uz¬goj konja i drugih kopitara" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneralPartners_AddressId",
                table: "GeneralPartners",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneralPartners_LimitedPartnershipRequestId",
                table: "GeneralPartners",
                column: "LimitedPartnershipRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitedCompanyFounders_AddressId",
                table: "LimitedCompanyFounders",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitedCompanyFounders_LimitedCompanyRequestId",
                table: "LimitedCompanyFounders",
                column: "LimitedCompanyRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitedPartners_AddressId",
                table: "LimitedPartners",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_LimitedPartners_LimitedPartnershipRequestId",
                table: "LimitedPartners",
                column: "LimitedPartnershipRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_EntrepreneurRequestId",
                table: "Owners",
                column: "EntrepreneurRequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Partners_PartnershipRequestId",
                table: "Partners",
                column: "PartnershipRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Shareholders_AddressId",
                table: "Shareholders",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Shareholders_JointStockCompanyRequestId",
                table: "Shareholders",
